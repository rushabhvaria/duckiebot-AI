...
Original file is located at
    https://colab.research.google.com/drive/1znPlrqSMftHrm2k9HhnkievFaLqzFAM1
...
Student #1 Name: Rushabh Varia

Student #2 Name: Divij Sachdeva
...
def calculate_radius(velocity_left, velocity_right):
    ...
    if (velocity_left == velocity_right) or velocity_left == ((-1) * velocity_right):
        return 0
    elif (velocity_right == 0) or (velocity_left == 0):
        radius = WHEEL_DIST/2
    else:
